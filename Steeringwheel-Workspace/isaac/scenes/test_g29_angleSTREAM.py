...
class SteeringDataStream:
    ...
    def _read_steering(self):
        ...
        base = self.stage.GetPrimAtPath("/G29_root/Steerbot_G29_base_position_27degrees")
        wheel = self.stage.GetPrimAtPath("/G29_root/Steerbot_G29_steerwheel_position_27degrees")
